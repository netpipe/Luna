...
/*----------------------------------------------------------------------------*/
Renderer22::Renderer22(IrrlichtDevice* devic, SColor diffuse)
{
  device = devic;
...
/*----------------------------------------------------------------------------*/
void Renderer22::addCam(ICameraSceneNode* camera)
//void Renderer22::addCam(f32 speed, vector3df pos, vector3df tgt, bool gravity)
{
cam = camera;
/*
...
/*----------------------------------------------------------------------------*/
void Renderer22::apply_light(SMaterial* mat)
{
...
/*----------------------------------------------------------------------------*/
void Renderer22::addMy3DScene(char* scene, f32 X, f32 Y, f32 Z)
{
...
/*----------------------------------------------------------------------------*/
void Renderer22::addSky(char *skytex)
{
    /*
...
/*----------------------------------------------------------------------------*/
void Renderer22::addWater(char* texture)
{
...
/*----------------------------------------------------------------------------*/
void Renderer22::loadModel(char *modelfile, vector3df pos)
{
...
/*----------------------------------------------------------------------------*/
void Renderer22::loadAnimatedModel(char *modelfile, vector3df pos)
{
  IAnimatedMesh* mesh = smgr->getMesh(modelfile);
  IAnimatedMeshSceneNode *node;
  node = smgr->addAnimatedMeshSceneNode(mesh);
