...
//https://www.dreamincode.net/forums/topic/157186-conversion-of-string-to-enum/
    ...
    enum eparamb2d{binit,binit2,brun,bgetx,bgety,brotation,bjoint,bapplyImpulse,btorque,bvelocity};
    std::map< std::string, eparamb2d > esb2d;

	enum veparam{vreset,vaccelerate,vreverse,vebrake,vbrake,vlsteer,
	vrsteer,vsteerreset,vrender,vsetpos,vgetx,vgety,vgetz,vstate,vrigidbody};
    ...
    enum gp{gpinit,gprefresh,gprun,gpunref,wiiled,gpudev,
    accx,accy,accz,
    accex,accey,accez,
...
// using enum eparamb2d;
    ...
    esb2d["bjoint"] = bjoint;
    esb2d["force"] = bapplyImpulse;
        esb2d["torque"] = btorque;
            esb2d["velocity"] = bvelocity;
