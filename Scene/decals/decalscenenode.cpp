...
ArmDecalSceneNode::ArmDecalSceneNode(ISceneNode* parent, ISceneManager* mgr,  ITexture* image, float size): ISceneNode(parent, mgr, 0)
{
...
void ArmDecalSceneNode::VNSetup(irr::core::vector3df normal,
...
vector3df up_vector = vector3df(0.0f, 1.0f, 0.0f);
//if (normal.X > normal.Y & normal.X > normal.Z){
//up_vector = vector3df(1.0f, 0.0f, 0.0f);
//}
//else if (normal.Y > normal.X & normal.Y > normal.Z){
//up_vector = vector3df(0.0f, 1.0f, 0.0f);
//}
//else if (normal.Z > normal.Y & normal.Z > normal.X){
//up_vector = vector3df(0.0f, 0.0f, 1.0f);
//}
        vector3df v1 = normal.crossProduct(up_vector);
        vector3df v3 = normal.crossProduct(v1);

       vector3df squarepA=intersection + (normal) + ((-v1 -v3)  * basesize);
       vector3df squarepB=intersection + (normal) + ((v1 - v3) * basesize);
       vector3df squarepC=intersection + (normal) + ((v1 + v3) * basesize);
       vector3df squarepD=intersection + (normal) + ((-v1 + v3) * basesize);
...
void ArmDecalSceneNode::Setup(triangle3df tri,
...
void ArmDecalSceneNode::setLifeSpan(double seconds){
lifeSpan=seconds;
}

void ArmDecalSceneNode::OnRegisterSceneNode()
{
if(lifeSpan>0)
{
...
const core::aabbox3d<f32>& ArmDecalSceneNode::getBoundingBox() const
{
return Box;
}
