...
void DecalSceneNode::Setup(vector3df normal,
...
//    D = PT + ((Right + Up) * Size)
       ...
       vector3df squarepA=(normal*-basesize)+(normal*-basesize);
       vector3df squarepB=squarepA+(normal*basesize*2);
       vector3df squarepC=squarepA+(normal*basesize*2)+(normal*basesize*2);
       vector3df squarepD=squarepA+(normal*basesize*2);
       ...
       Vertices[0] = S3DVertex(squarepA.X,squarepA.Y+3,squarepA.Z, 1,0,0,color,1,0);
       Vertices[1] = S3DVertex(squarepB.X,squarepB.Y+3,squarepB.Z, 1,0,0,color,1,1);
       Vertices[2] = S3DVertex(squarepC.X,squarepC.Y+3,squarepC.Z, 1,0,0,color,0,1);
       Vertices[3] = S3DVertex(squarepD.X,squarepD.Y+3,squarepD.Z, 1,0,0,color,0,0);
