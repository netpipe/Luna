...
TesselatedImage::TesselatedImage(IrrlichtDevice *device2, stringc img, vector3df startFr, vector3df startTo, vector3df targetPos, float speed, int maxTes, float colChange, Type type, float dim, float gap)
{
...
device = device2;
    ...
    for (unsigned int i=0; i < size; i ++)
    {
        ...
        else
        {
            ...
            ITexture *tex = driver->getTexture("media/ballf.png");
...
//void TesselatedImage::OnRegisterSceneNode() {
//
//            device->getSceneManager()->registerNodeForRendering(this);
//
//            ISceneNode::OnRegisterSceneNode();
//}

void TesselatedImage::render(float frameDeltaTime2){
