...
CEffectPostProc::CEffectPostProc( IPostProc* follow1, irr::core::dimension2du sOut, POSTPROC_EFFECTID effectID, irr::f32 para1, irr::f32 para2, irr::f32 para3, irr::f32 para4, irr::f32 para5, irr::f32 para6, irr::f32 para7, irr::f32 para8 ) : IPostProc( follow1, sOut ) {
	...
	if( supported ) {
		...
		switch( effectID ) {
			case PP_DIRECT:
				setShader( NULL, NULL, irr::video::EPST_PS_1_1, irr::video::EPST_PS_1_1 );
				break;
			case PP_PUNCH:
				...
				scEffect.usesnum = 4u;
				setShader( GL_PUNCH, DX_PUNCH, irr::video::EPST_PS_1_1, irr::video::EPST_PS_2_0 );
				break;
			case PP_PIXELATE:
				if( para1 == FLOAT_DEFAULTVALUE )	para1 = 0.01f;
				if( para2 == FLOAT_DEFAULTVALUE )	para2 = para1;
				scEffect.usesnum = 2u;
				setShader( GL_PIXELATE, DX_PIXELATE, irr::video::EPST_PS_1_1, irr::video::EPST_PS_2_0 );
				break;
			case PP_PIXELATEBANDS:
				...
				scEffect.usesnum = 3u;
				setShader( GL_PIXELATEBANDS, DX_PIXELATEBANDS, irr::video::EPST_PS_1_1, irr::video::EPST_PS_2_0 );
				break;
			case PP_DEPTH:
				if( para1 == FLOAT_DEFAULTVALUE )	para1 = 0.0f;
				if( para2 == FLOAT_DEFAULTVALUE )	para2 = 200.0f;
				scEffect.usesnum = 2u;
				setShader( GL_DEPTH, DX_DEPTH, irr::video::EPST_PS_1_1, irr::video::EPST_PS_2_0 );
				break;
			case PP_OCCLUSION:
				if( para1 == FLOAT_DEFAULTVALUE )	para1 = 1.0f;
				scEffect.usesnum = 3u;
				setShader( GL_OCCLUSION, DX_OCCLUSION, irr::video::EPST_PS_1_1, irr::video::EPST_PS_2_0 );
				setShader( GL_OCCLUSIONFAST, DX_OCCLUSIONFAST, irr::video::EPST_PS_1_1, irr::video::EPST_PS_2_0, &mat2 );
				break;
			case PP_DARKEN:
				if( para1 == FLOAT_DEFAULTVALUE )	para1 = 1.0f;
				scEffect.usesnum = 1u;
				setShader( GL_DARKEN, DX_DARKEN, irr::video::EPST_PS_1_1, irr::video::EPST_PS_2_0 );
				break;
			case PP_LIGHTEN:
				if( para1 == FLOAT_DEFAULTVALUE )	para1 = 1.0f;
				scEffect.usesnum = 1u;
				setShader( GL_LIGHTEN, DX_LIGHTEN, irr::video::EPST_PS_1_1, irr::video::EPST_PS_2_0 );
				break;
			case PP_RANGE:
				if( para1 == FLOAT_DEFAULTVALUE )	para1 = 0.0f;
				if( para2 == FLOAT_DEFAULTVALUE )	para2 = 1.0f;
				scEffect.usesnum = 2u;
				setShader( GL_RANGE, DX_RANGE, irr::video::EPST_PS_1_1, irr::video::EPST_PS_2_0 );
				break;
			case PP_INVERT:
				setShader( GL_INVERT, DX_INVERT, irr::video::EPST_PS_1_1, irr::video::EPST_PS_1_1 );
				break;
			case PP_CURVES:
				...
				scEffect.usesnum = 3u;
				setShader( GL_CURVES, DX_CURVES, irr::video::EPST_PS_1_1, irr::video::EPST_PS_2_0 );
				break;
			case PP_TINT:
				if( para2 == FLOAT_DEFAULTVALUE && para3 == FLOAT_DEFAULTVALUE ) {
					para2 = para1;
				...
				scEffect.usesnum = 4u;
				setShader( GL_TINT, DX_TINT, irr::video::EPST_PS_1_1, irr::video::EPST_PS_2_0 );
				break;
			case PP_GREYSCALE:
				if( para1 == FLOAT_DEFAULTVALUE )	para1 = 1.0f;
				scEffect.usesnum = 4u;
			...
			case PP_VIGNETTE:
				...
				if( para3 == FLOAT_DEFAULTVALUE )	para3 = 1.0f;
				scEffect.usesnum = 3u;
				setShader( GL_VIGNETTE, DX_VIGNETTE, irr::video::EPST_PS_1_1, irr::video::EPST_PS_2_0 );
				break;
			case PP_NOISE:
				if( para1 == FLOAT_DEFAULTVALUE )	para1 = 0.1f;
				scEffect.usesnum = 1u;
				scEffect.usesrand = true;
				setShader( GL_NOISE, DX_NOISE, irr::video::EPST_PS_1_1, irr::video::EPST_PS_2_0 );
				break;
			case PP_COLORNOISE:
				if( para1 == FLOAT_DEFAULTVALUE )	para1 = 0.1f;
				scEffect.usesnum = 1u;
				scEffect.usesrand = true;
				setShader( GL_COLORNOISE, DX_COLORNOISE, irr::video::EPST_PS_1_1, irr::video::EPST_PS_2_0 );
				break;
			case PP_HBLUR:
				if( para1 == FLOAT_DEFAULTVALUE )	para1 = 0.01f;
				scEffect.usesnum = 1u;
				setShader( GL_HBLUR_5, DX_HBLUR_5, irr::video::EPST_PS_1_2, irr::video::EPST_PS_2_0 );
			...
			case PP_VBLUR:
				if( para1 == FLOAT_DEFAULTVALUE )	para1 = 0.01f;
				scEffect.usesnum = 1u;
				setShader( GL_VBLUR_5, DX_VBLUR_5, irr::video::EPST_PS_1_2, irr::video::EPST_PS_2_0 );
			...
			case PP_BIBLUR:
				...
				if( para2 == FLOAT_DEFAULTVALUE )	para2 = para1;
				scEffect.usesnum = 2u;
				setShader( GL_BIBLUR_9, DX_BIBLUR_9, irr::video::EPST_PS_1_2, irr::video::EPST_PS_2_0 );
			...
			case PP_HBLURDOFFAR:
				...
				if( para3 == FLOAT_DEFAULTVALUE )	para3 = 0.01f;
				scEffect.usesnum = 3u;
				setShader( GL_HBLURDOFFAR_5, DX_HBLURDOFFAR_5, irr::video::EPST_PS_1_2, irr::video::EPST_PS_2_0 );
			...
			case PP_VBLURDOFFAR:
				...
				if( para3 == FLOAT_DEFAULTVALUE )	para3 = 0.01f;
				scEffect.usesnum = 3u;
				setShader( GL_VBLURDOFFAR_5, DX_VBLURDOFFAR_5, irr::video::EPST_PS_1_2, irr::video::EPST_PS_2_0 );
			...
			case PP_HBLURDOFNEAR:
				...
				if( para3 == FLOAT_DEFAULTVALUE )	para3 = 0.01f;
				scEffect.usesnum = 3u;
				setShader( GL_HBLURDOFNEAR_5, DX_HBLURDOFNEAR_5, irr::video::EPST_PS_1_2, irr::video::EPST_PS_2_0 );
			...
			case PP_VBLURDOFNEAR:
				...
				if( para3 == FLOAT_DEFAULTVALUE )	para3 = 0.01f;
				scEffect.usesnum = 3u;
				setShader( GL_VBLURDOFNEAR_5, DX_VBLURDOFNEAR_5, irr::video::EPST_PS_1_2, irr::video::EPST_PS_2_0 );
			...
			case PP_LINEARBLUR:
				...
				scEffect.usesnum = 2u;
				setShader( GL_LINEARBLUR_5, DX_LINEARBLUR_5, irr::video::EPST_PS_1_2, irr::video::EPST_PS_2_0 );
			...
			case PP_RADIALBLUR:
				...
				scEffect.usesnum = 4u;
				setShader( GL_RADIALBLUR_5, DX_RADIALBLUR_5, irr::video::EPST_PS_1_2, irr::video::EPST_PS_2_0 );
			...
			case PP_RADIALBEAM:
				...
				if( para4 == FLOAT_DEFAULTVALUE ) para4 = para3;
				scEffect.usesnum = 4u;
				setShader( GL_RADIALBEAM_5, DX_RADIALBEAM_5, irr::video::EPST_PS_1_2, irr::video::EPST_PS_2_0 );
			...
			case PP_ROTATIONALBLUR:
				...
				if( para4 == FLOAT_DEFAULTVALUE ) para4 = para3;
				scEffect.usesnum = 4u;
				setShader( GL_ROTATIONALBLUR_5, DX_ROTATIONALBLUR_5, irr::video::EPST_PS_1_2, irr::video::EPST_PS_2_0 );
			...
			case PP_MOTIONBLUR:
				...
				setShader( GL_MOTIONBLUR2, DX_MOTIONBLUR2, irr::video::EPST_PS_1_1, irr::video::EPST_PS_1_1 );
				break;
			case PP_HAZE:
				...
				setShader( GL_HAZE, DX_HAZE, irr::video::EPST_PS_1_2, irr::video::EPST_PS_2_0 );
				break;
			case PP_HAZEDEPTH:
				if( para1 == FLOAT_DEFAULTVALUE ) para1 = 0.005f;
				if( para2 == FLOAT_DEFAULTVALUE ) para2 = 0.5f;
				...
				scEffect.usesnum = 4u;
				scEffect.usestime = true;
				setShader( GL_HAZEDEPTH, DX_HAZEDEPTH, irr::video::EPST_PS_1_2, irr::video::EPST_PS_2_0 );
			...
			case PP_OVERLAY:
				...
				setShader( GL_OVERLAY2, DX_OVERLAY2, irr::video::EPST_PS_1_1, irr::video::EPST_PS_1_1 );
				break;
			case PP_OVERLAYNEG:
				if( para1 == FLOAT_DEFAULTVALUE )	para1 = 1.0f;
				scEffect.usesnum = 1u;
				setShader( GL_OVERLAYNEG, DX_OVERLAYNEG, irr::video::EPST_PS_1_1, irr::video::EPST_PS_2_0 );
				break;
		}
...
CEffectPostProc::CEffectPostProc( IPostProc* follow1, irr::core::dimension2du sOut, const irr::c8* prog_gl, const irr::c8* prog_dx, irr::video::E_PIXEL_SHADER_TYPE gl_ps, irr::video::E_PIXEL_SHADER_TYPE dx_ps, irr::video::E_MATERIAL_TYPE optimize, POSTPROC_FLAGS flags, irr::f32 para1, irr::f32 para2, irr::f32 para3, irr::f32 para4, irr::f32 para5, irr::f32 para6, irr::f32 para7, irr::f32 para8 ) : IPostProc( follow1, sOut ) {
	...
	if( supported ) {
		...
		if( flags & PPF_FROMFILE )
			...
			setShader( prog_gl, prog_dx, gl_ps, dx_ps );
		setParameters( para1, para2, para3, para4, para5, para6, para7, para8 );
	}
	setInput( 0u, follow1 );
}
CEffectPostProc::CEffectPostProc( IPostProc* follow1, irr::core::dimension2du sOut, irr::io::IReadFile* file_gl, irr::io::IReadFile* file_dx, irr::video::E_PIXEL_SHADER_TYPE gl_ps, irr::video::E_PIXEL_SHADER_TYPE dx_ps, irr::video::E_MATERIAL_TYPE optimize, irr::f32 para1, irr::f32 para2, irr::f32 para3, irr::f32 para4, irr::f32 para5, irr::f32 para6, irr::f32 para7, irr::f32 para8 ) : IPostProc( follow1, sOut ) {
	irr::video::IVideoDriver* driver = smgr->getVideoDriver( );
	useTextureOptimize = optimize;
	eff = PP_CUSTOM;
