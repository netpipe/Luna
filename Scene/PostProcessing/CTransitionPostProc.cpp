...
CTransitionPostProc::CTransitionPostProc( IPostProc* follow1, IPostProc* follow2, irr::core::dimension2du sOut, irr::video::ITexture* m ) : IPostProc( follow1, sOut ) {
...
//			//case irr::video::EDT_DIRECT3D8:
		...
		matFast.Wireframe = false;
		matFast.Lighting = false;
		matFast.FogEnable = false;
		matFast.ZBuffer = 0;
		matFast.setTexture( 1u, tmap );
		matFast.TextureLayer[ 0u ].TextureWrapU = irr::video::ETC_CLAMP_TO_EDGE;
		matFast.TextureLayer[ 1u ].TextureWrapV = irr::video::ETC_CLAMP_TO_EDGE;
		matFast.TextureLayer[ 0u ].BilinearFilter = false;
