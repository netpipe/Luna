...
private:
	...
	void setShader( const irr::c8* prog_gl, const irr::c8* prog_dx, irr::video::E_PIXEL_SHADER_TYPE gl_ps, irr::video::E_PIXEL_SHADER_TYPE dx_ps ) { setShader( prog_gl, prog_dx, gl_ps, dx_ps, &mat ); };

protected:
	virtual void configureInput( irr::u8 n );

public:
	CEffectPostProc( IPostProc* follow1, irr::core::dimension2du sOut, POSTPROC_EFFECTID effectID, irr::f32 para1 = FLOAT_DEFAULTVALUE, irr::f32 para2 = FLOAT_DEFAULTVALUE, irr::f32 para3 = FLOAT_DEFAULTVALUE, irr::f32 para4 = FLOAT_DEFAULTVALUE, irr::f32 para5 = FLOAT_DEFAULTVALUE, irr::f32 para6 = FLOAT_DEFAULTVALUE, irr::f32 para7 = FLOAT_DEFAULTVALUE, irr::f32 para8 = FLOAT_DEFAULTVALUE );
	CEffectPostProc( IPostProc* follow1, irr::core::dimension2du sOut, const irr::c8* prog_gl, const irr::c8* prog_dx, irr::video::E_PIXEL_SHADER_TYPE gl_ps = irr::video::EPST_PS_1_1, irr::video::E_PIXEL_SHADER_TYPE dx_ps = irr::video::EPST_PS_1_1, irr::video::E_MATERIAL_TYPE optimize = irr::video::EMT_SOLID, POSTPROC_FLAGS flags = PPF_DEFAULT, irr::f32 para1 = 0.0f, irr::f32 para2 = 0.0f, irr::f32 para3 = 0.0f, irr::f32 para4 = 0.0f, irr::f32 para5 = 0.0f, irr::f32 para6 = 0.0f, irr::f32 para7 = 0.0f, irr::f32 para8 = 0.0f );
	CEffectPostProc( IPostProc* follow1, irr::core::dimension2du sOut, irr::io::IReadFile* file_gl, irr::io::IReadFile* file_dx, irr::video::E_PIXEL_SHADER_TYPE gl_ps = irr::video::EPST_PS_1_1, irr::video::E_PIXEL_SHADER_TYPE dx_ps = irr::video::EPST_PS_1_1, irr::video::E_MATERIAL_TYPE optimize = irr::video::EMT_SOLID, irr::f32 para1 = 0.0f, irr::f32 para2 = 0.0f, irr::f32 para3 = 0.0f, irr::f32 para4 = 0.0f, irr::f32 para5 = 0.0f, irr::f32 para6 = 0.0f, irr::f32 para7 = 0.0f, irr::f32 para8 = 0.0f );
