...
private:
	...
	void init( IPostProc* follow, irr::core::dimension2du sOut, irr::video::ITexture* m );

public:
	CLensFlarePostProc( IPostProc* follow, irr::core::dimension2du sOut, irr::video::ITexture* m, irr::core::vector3d<irr::f32> p = irr::core::vector3d<irr::f32>( 0.0f, 0.0f, 0.0f ), irr::f32 r = 0.0f );
	CLensFlarePostProc( IPostProc* follow, irr::core::dimension2du sOut, irr::video::ITexture* m, irr::scene::ISceneNode* p, irr::f32 r = 0.0f );
