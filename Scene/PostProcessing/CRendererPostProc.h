...
public:
	CRendererPostProc( irr::scene::ISceneManager* sm, irr::core::dimension2du sOut, bool clearBackBuffer = true, bool clearZBuffer = true, irr::video::SColor color = irr::video::SColor( 0u, 0u, 0u, 0u ) );
