...
{
//	m_tempSndSrc = GSoundWorld->CacheSound( PATH_TO_MEDIA "Sounds/Misc/Impact/test_impact.ogg" );
//	m_tempSndSrc->setDefaultMinDistance( 300 );
}

mxMaterialSystem::~mxMaterialSystem()
{}

//mxSoundSource* mxMaterialSystem::GetSoundForMaterials( const mxMaterial* material0, const mxMaterial* material1, const ContactInfo_s& contactInfo )
//{
//	m_tempSndSrc->setDefaultVolume( contactInfo.impulse / 600 );
//	return m_tempSndSrc;
//}
