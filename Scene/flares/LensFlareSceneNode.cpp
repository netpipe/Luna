...
LensFlareSceneNode::LensFlareSceneNode(ISceneNode* parent, ISceneManager* mgr, s32 id) :
	scene::ISceneNode(parent, mgr, id)
{
	#ifdef _DEBUG
	setDebugName("LensFlareSceneNode");
	#endif
...
LensFlareSceneNode::~LensFlareSceneNode()
{
}

u32 LensFlareSceneNode::getMaterialCount() const
{
	// return the material count (always one in our case)
	return 1;
}

video::SMaterial& LensFlareSceneNode::getMaterial(u32 i)
{
	// return the material
    return Material;
}

core::array<SFlareData>& LensFlareSceneNode::getFlareData()
{
	// return the flare data array
	return FlareData;
}

void LensFlareSceneNode::OnRegisterSceneNode()
{
...
void LensFlareSceneNode::render()
{
...
const core::aabbox3df& LensFlareSceneNode::getBoundingBox() const
{
	// return the bounding box
	return BBox;
}

ESCENE_NODE_TYPE LensFlareSceneNode::getType() const
{
...
void LensFlareSceneNode::serializeAttributes(io::IAttributes* out, io::SAttributeReadWriteOptions* options) const
{
	// write attributes of the scene node.
	ISceneNode::serializeAttributes(out, options);
}

void LensFlareSceneNode::deserializeAttributes(io::IAttributes* in, io::SAttributeReadWriteOptions* options)
{
	// read attributes of the scene node.
	ISceneNode::deserializeAttributes(in, options);
}

ISceneNode* LensFlareSceneNode::clone(ISceneNode* newParent, ISceneManager* newManager)
{
	if (!newParent)
		newParent = Parent;
	if (!newManager)
	...
	LensFlareSceneNode* nb = new LensFlareSceneNode(newParent, newManager, ID);
