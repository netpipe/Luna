...
const char* keywords[NUM_KEYWORDS] = {"FileGlobal", "Scene", "Object", "bSensor", "bKeyboardSensor", "bAlwaysSensor", "bController","bActuator","bIpoActuator","bRigidBodyJointConstraint", "bConstraint"};
...
//											printf("...\n");
											...
											//if (blend_object_structure_getfield(bf, &obj2, ipo,"curve"))
											{
												...
												{
													///todo: fix ptr issue
													BlendBlock * curveblockptr = blend_block_from_blendpointer(bf, (uint64_t)ptr);
