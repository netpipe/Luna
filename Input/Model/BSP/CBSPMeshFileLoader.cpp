...
//! Constructor
CBSPMeshFileLoader2::CBSPMeshFileLoader2(scene::ISceneManager* smgr,
		io::IFileSystem* fs)
...
//! destructor
CBSPMeshFileLoader2::~CBSPMeshFileLoader2()
{
	if (FileSystem)
		FileSystem->drop();
}
...
bool CBSPMeshFileLoader2::isALoadableFileExtension(const io::path& filename) const
{
...
IAnimatedMesh* CBSPMeshFileLoader2::createMesh(io::IReadFile* file)
{
