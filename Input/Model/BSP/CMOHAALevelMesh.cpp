// MOHAA loader written by Michael Rieder
// based on
// CQ3LevelMesh.cpp Copyright (C) 2002-2011 Nikolaus Gebhardt
// This file is part of the "Irrlicht Engine".
// For conditions of distribution and use, see copyright notice in irrlicht.h

#include "../../../config.h"
#include "IrrCompileConfig.h"
//#ifdef _IRR_COMPILE_WITH_BSP_LOADER_2
#ifdef test223
...
//! constructor
CMOHAALevelMesh::CMOHAALevelMesh(io::IFileSystem* fs, scene::ISceneManager* smgr,
...
{
	#ifdef _DEBUG
	IReferenceCounted::setDebugName("CMOHAALevelMesh");
	#endif
...
f32 CMOHAALevelMesh::getAnimationSpeed() const {};
void CMOHAALevelMesh::setAnimationSpeed(f32 fps){};
IMesh* CMOHAALevelMesh::CMOHAALevelMesh::getBrushEntityMesh(s32 num) const {};
IMesh* CMOHAALevelMesh::getBrushEntityMesh(quake3::IEntity &ent) const{};

//! destructor
CMOHAALevelMesh::~CMOHAALevelMesh()
{
	cleanLoader ();
...
bool CMOHAALevelMesh::loadFile(io::IReadFile* file)
{
	if (!file)
		return false;
	...
	if (	header.strID != 0x35313032 ||			// 2015
	...
	// fogs are handled differently (TODO)
...
/*!
*/
void CMOHAALevelMesh::cleanLoader ()
{
...
u32 CMOHAALevelMesh::getFrameCount() const
{
	return 1;
}
...
void CMOHAALevelMesh::loadTextures(tBSPLump* l, io::IReadFile* file)
{
...
void CMOHAALevelMesh::loadLightmaps(tBSPLump* l, io::IReadFile* file)
{
...
/*!
*/
void CMOHAALevelMesh::loadVerts(tBSPLump* l, io::IReadFile* file)
{
...
/*!
*/
void CMOHAALevelMesh::loadFaces(tBSPLump* l, io::IReadFile* file)
{
...
/*!
*/
void CMOHAALevelMesh::loadPlanes(tBSPLump* l, io::IReadFile* file)
{
	// ignore
}
...
/*!
*/
void CMOHAALevelMesh::loadNodes(tBSPLump* l, io::IReadFile* file)
{
	// ignore
}
...
/*!
*/
void CMOHAALevelMesh::loadLeafs(tBSPLump* l, io::IReadFile* file)
{
	// ignore
}
...
/*!
*/
void CMOHAALevelMesh::loadLeafFaces(tBSPLump* l, io::IReadFile* file)
{
	// ignore
}
...
/*!
*/
void CMOHAALevelMesh::loadVisData(tBSPLump* l, io::IReadFile* file)
{
	// ignore
}
...
/*!
*/
void CMOHAALevelMesh::loadEntities(tBSPLump* l, io::IReadFile* file)
{
	...
	parser_parse( entity.pointer(), l->length, &CMOHAALevelMesh::scriptcallback_entity );
}
...
/*!
	load fog brushes
*/
void CMOHAALevelMesh::loadFogs(tBSPLump* l, io::IReadFile* file)
{
...
*/
void CMOHAALevelMesh::loadModels(tBSPLump* l, io::IReadFile* file)
{
...
/*!
*/
void CMOHAALevelMesh::loadMeshVerts(tBSPLump* l, io::IReadFile* file)
{
...
/*!
*/
void CMOHAALevelMesh::loadBrushes(tBSPLump* l, io::IReadFile* file)
{
	// ignore
}
...
/*!
*/
void CMOHAALevelMesh::loadBrushSides(tBSPLump* l, io::IReadFile* file)
{
	// ignore
}
...
/*!
*/
void CMOHAALevelMesh::loadLeafBrushes(tBSPLump* l, io::IReadFile* file)
{
	// ignore
}
...
/*!
*/
void CMOHAALevelMesh::parser_nextToken()
{
	u8 symbol;
...
*/
void CMOHAALevelMesh::parser_parse( const void * data, const u32 size, CMOHAALevelMesh::tParserCallback callback )
{
...
*/
s32 CMOHAALevelMesh::setShaderFogMaterial( video::SMaterial &material, const tBSPFace * face ) const
{
...
/*
	this loader applies only textures for stage 1 & 2
*/
s32 CMOHAALevelMesh::setShaderMaterial( video::SMaterial &material, const tBSPFace * face ) const
{
	material.MaterialType = video::EMT_SOLID;
	material.Wireframe = false;
	material.Lighting = false;
...
/*!
*/
void CMOHAALevelMesh::solveTJunction()
{
}
...
*/
void CMOHAALevelMesh::constructMesh()
{
...
void CMOHAALevelMesh::S3DVertex2TCoords_64::copy( video::S3DVertex2TCoords &dest ) const
{
...
void CMOHAALevelMesh::copy( S3DVertex2TCoords_64 * dest, const tBSPVertex * source, s32 vertexcolor ) const
{
#if defined (TJUNCTION_SOLVER_ROUND)
...
inline void CMOHAALevelMesh::copy( video::S3DVertex2TCoords * dest, const tBSPVertex * source, s32 vertexcolor ) const
{
#if defined (TJUNCTION_SOLVER_ROUND)
	dest->Pos.X = core::round_( source->vPosition[0] );
	dest->Pos.Y = core::round_( source->vPosition[2] );
...
void CMOHAALevelMesh::SBezier::tesselate( s32 level )
{
...
/*!
	no subdivision
*/
void CMOHAALevelMesh::createCurvedSurface_nosubdivision(SMeshBufferLightMap* meshBuffer,
					s32 faceIndex,
...
/*!
*/
void CMOHAALevelMesh::createCurvedSurface_bezier(SMeshBufferLightMap* meshBuffer,
					s32 faceIndex,
					s32 patchTesselation,
					s32 storevertexcolor)
{
...
*/
void CMOHAALevelMesh::getConfiguration( io::IReadFile* file )
{
	tBSPLump l;
	...
	parser_parse( entity.pointer(), l.length, &CMOHAALevelMesh::scriptcallback_config );
...
tQ3EntityList & CMOHAALevelMesh::getEntityList()
{
//	Entity.sort();
	return Entity;
}
...
/*!
*/
const IShader * CMOHAALevelMesh::getShader(u32 index) const
{
	index &= 0xFFFF;
...
*/
const IShader* CMOHAALevelMesh::getShader( const c8 * filename, bool fileNameIsValid )
{
...
/*!
	loads the shader definition
*/
void CMOHAALevelMesh::getShader( io::IReadFile* file )
{
	if ( 0 == file )
		return;
	...
	parser_parse( script.pointer(), len, &CMOHAALevelMesh::scriptcallback_shader );
}


//! adding default shaders
void CMOHAALevelMesh::InitShader()
{
	ReleaseShader();
...
void CMOHAALevelMesh::ReleaseShader()
{
...
/*!
*/
void CMOHAALevelMesh::ReleaseEntity()
{
...
void CMOHAALevelMesh::scriptcallback_config( SVarGroupList *& grouplist, eToken token )
{
	IShader element;
...
void CMOHAALevelMesh::scriptcallback_entity( SVarGroupList *& grouplist, eToken token )
{
...
//!. script callback for shaders
void CMOHAALevelMesh::scriptcallback_shader( SVarGroupList *& grouplist,eToken token )
{
...
*/
void CMOHAALevelMesh::cleanMeshes()
{
...
void CMOHAALevelMesh::calcBoundingBoxes()
{
	if ( LoadParam.verbose > 0 )
	{
		LoadParam.startTime = os::Timer::getRealTime();
...
//! loads the textures
void CMOHAALevelMesh::loadTextures()
{
	if (!Driver)
		return;
...
//	Driver->setTextureCreationFlag(video::ETCF_CREATE_MIP_MAPS, oldMipMapState);
	...
	for ( t=0; t< NumTextures; ++t)
	{
		...
		shader = getShader( Textures[t].strName, false);
		if ( 0 /*shader*/ )		// the shader loading must be fixed. for now load .tga files directly
		{
...
const core::aabbox3d<f32>& CMOHAALevelMesh::getBoundingBox() const
{
	return Mesh[0]->getBoundingBox();
}


void CMOHAALevelMesh::setBoundingBox(const core::aabbox3df& box)
{
...
E_ANIMATED_MESH_TYPE CMOHAALevelMesh::getMeshType() const
{
