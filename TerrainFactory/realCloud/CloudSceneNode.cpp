...
CloudSceneNode::CloudSceneNode(scene::ISceneNode* parent, scene::ISceneManager* mgr, s32 id) :
	scene::ISceneNode(parent, mgr, id)
{
	#ifdef _DEBUG
	setDebugName("CloudSceneNode");
	#endif
...
void CloudSceneNode::createCloudLayer()
{
...
void CloudSceneNode::setTranslation(const core::vector2d<f32>& translation)
{
	// set the translation
	Translation = translation;
}

void CloudSceneNode::setTextureScale(f32 textureScale)
{
	// set the texture scale
...
void CloudSceneNode::setCloudRadius(f32 innerRadius, f32 outerRadius)
{
...
void CloudSceneNode::setCloudHeight(f32 centerHeight, f32 innerHeight, f32 outerHeight)
{
...
void CloudSceneNode::setCloudColor(const video::SColor& centerColor, const video::SColor& innerColor, const video::SColor& outerColor)
{
...
void CloudSceneNode::OnRegisterSceneNode()
{
...
void CloudSceneNode::OnAnimate(u32 timeMs)
{
	// call base OnAnimate
...
const core::aabbox3d<f32>& CloudSceneNode::getBoundingBox() const
{
	// return the bounding box
	return BBox;
}

ESCENE_NODE_TYPE CloudSceneNode::getType() const
{
...
u32 CloudSceneNode::getMaterialCount() const
{
	// return the material count (always one in our case)
	return 1;
}

video::SMaterial& CloudSceneNode::getMaterial(u32 i)
{
	// return the material
	return Material;
}

void CloudSceneNode::serializeAttributes(io::IAttributes* out, io::SAttributeReadWriteOptions* options) const
{
...
void CloudSceneNode::deserializeAttributes(io::IAttributes* in, io::SAttributeReadWriteOptions* options)
{
...
ISceneNode* CloudSceneNode::clone(ISceneNode* newParent, ISceneManager* newManager)
{
	// set the parent
	if (!newParent)
		newParent = Parent;
	...
	CloudSceneNode* nb = new CloudSceneNode(newParent, newManager, ID);
