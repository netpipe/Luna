...
{
    public:
        IRaycastVehicle(IRigidBody* const body, const irr::core::vector3d<irr::s32>& coordSys=irr::core::vector3d<irr::s32>(0,1,2));
        IRaycastVehicle(IRigidBody* const body, btVehicleRaycaster* const raycaster,
        ...
        */
        ...
        btRaycastVehicle* getPointer() const { return raycastVehicle; };

        /// Gets the rigid body that this vehicle is applied to.
        IRigidBody* getRigidBody() const { return rigidBody; };
        ...
        IVehicleRaycaster* getVehicleRaycaster() const { return static_cast<IVehicleRaycaster*>(vehicleRaycaster); };

        /// Use this if you use your own custom vehicle raycaster.
        btVehicleRaycaster* getVehicleRaycasterCustom() const { return vehicleRaycaster; };
