...
public:
    ...
    */
    ...
    btRigidBody* getPointer() const { return static_cast<btRigidBody*>(object); };
    ...
    */
    ...
    IMotionState* getMotionState() const { return motionState; };

    /// Only use this function if you actually set the vehicle with setVehicleReference(); returns 0 if no vehicle was set
    IRaycastVehicle* getVehicleReference() const { if(vehicleReference) return vehicleReference; else return 0; };
