...
ILiquidBody::ILiquidBody(irrBulletWorld* const world, const irr::core::vector3df& pos,
    ...
    DynamicsWorld(world), Device(DynamicsWorld->getIrrlichtDevice()), LiquidExtents(aabb),
    GlobalWaveUpdateFrequency(waveFrequency), LiquidDensity(density), Infinite(makeInfinite)
{
