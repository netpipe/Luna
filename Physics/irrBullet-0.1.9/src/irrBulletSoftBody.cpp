...
void ISoftBody::configureSoftBody()
{
    ...
    // Set defaults
    getPointer()->m_cfg.kDP = 0.0f;  // Damping coefficient [0,1]
    getPointer()->m_cfg.kDF = 0.2f;  // Dynamic friction coefficient [0,1]
    getPointer()->m_cfg.kMT = 0.02f; // Pose matching coefficient [0,1]
    getPointer()->m_cfg.kCHR = 1.0f; // Rigid contacts hardness [0,1]
    getPointer()->m_cfg.kKHR = 0.8f; // Kinetic contacts hardness [0,1]
    getPointer()->m_cfg.kSHR = 1.0f; // Soft contacts hardness [0,1]
    getPointer()->m_cfg.piterations=2;
    getPointer()->m_materials[0]->m_kLST = 0.8f;
    getPointer()->m_materials[0]->m_kAST = 0.8f;
    getPointer()->m_materials[0]->m_kVST = 0.8f;
